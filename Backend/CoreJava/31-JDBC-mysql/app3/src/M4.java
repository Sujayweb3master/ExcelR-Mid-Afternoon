...
class M4 
{
	...
	public static void main(String[] args) 
	{
		...
		//all these three Connection, Statement, ResultSet are closeable and extends Auto closeable interface
		...
		// immediately after execution of try automatically resources will be closed.
